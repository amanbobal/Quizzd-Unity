...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    [SerializeField] private List<GameObject> TabBtnAnims;
    ...
    void Awake() {
        ...
        {
            Button TabBtn = TabButtons[i];
            TabBtn.onClick.AddListener(() => OnClick(TabBtn));
        }

        Invoke("TabAnims", 0.75f);
	}
    ...
    //------------------------------------------------------------------------
    private void TabAnims()
    {
        if (_currentPage == 0)
        {
            TabButtons[0].image.enabled = false;
            TabBtnAnims[0].SetActive(true);
        }
        else
        {
            TabButtons[0].image.enabled = true;
            TabBtnAnims[0].SetActive(false);
        }
        if (_currentPage == 1)
        {
            TabButtons[1].image.enabled = false;
            TabBtnAnims[1].SetActive(true);
        }
        else
        {
            TabButtons[1].image.enabled = true;
            TabBtnAnims[1].SetActive(false);
        }
        if (_currentPage == 2)
        {
            TabButtons[2].image.enabled = false;
            TabBtnAnims[2].SetActive(true);
        }
        else
        {
            TabButtons[2].image.enabled = true;
            TabBtnAnims[2].SetActive(false);
        }
        if (_currentPage == 3)
        {
            TabButtons[3].image.enabled = false;
            TabBtnAnims[3].SetActive(true);
        }
        else
        {
            TabButtons[3].image.enabled = true;
            TabBtnAnims[3].SetActive(false);
        }
    }
